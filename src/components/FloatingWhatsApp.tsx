...
// Floating chat button. Instead of a direct generic WhatsApp link (which
// flooded the inbox with context-free "Hi DFA" messages), it now opens the
// screening funnel — so every inbound message arrives qualified, with answers.
